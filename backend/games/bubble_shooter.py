...
class BubbleShooterGame:
    ...
    ANGRY_TARGET_SCORE = 800
    DEFAULT_TIME_LIMIT = 45  # seconds
    ANGRY_TIME_LIMIT = 30
    ...
    def validate_result(
        ...
        # Allow 10 second network and interaction buffer
        ...
        if reported_score < target_score:
            return False, f"Score too low! You scored {reported_score}, but I demanded {target_score} points! The answer remains locked."
